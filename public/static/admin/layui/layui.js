/** v2.8.12 | MIT Licensed */
;!function (d) {
    "use strict";
    var t, h = d.document, m = {modules: {}, status: {}, timeout: 10, event: {}}, o = function () {
        this.v = "2.8.12"
    }, e = d.LAYUI_GLOBAL || {}, v = (t = h.currentScript ? h.currentScript.src : function () {
        for (var t, e = h.scripts, n = e.length - 1, o = n; 0 < o; o--) if ("interactive" === e[o].readyState) {
            t = e[o].src;
            break
        }
        return t || e[n].src
        ...
        var p,
            y = (y = (N[u] ? i + "modules/" : !/^\{\/\}/.test(r.modules[u]) && m.base || "") + (r.modules[u] || u) + ".js").replace(/^\{\/\}/, "");
        ...
        var r = this, e = h.getElementsByTagName("head")[0], i = h.createElement("link"),
            a = "layuicss-" + ((t = "string" == typeof o ? o : t) || n).replace(/\.|\//g, ""), u = "creating", l = 0;
        ...
        return {
            ...
            search: (r = {}, e = (t ? ((t.match(/\?.+/) || [])[0] || "").replace(/\#.+/, "") : location.search).replace(/^\?+/, "").split("&"), n.each(e, function (t, e) {
                var n = e.indexOf("="), o = n < 0 ? e.substr(0, e.length) : 0 !== n && e.substr(0, n);
        ...
        var n = navigator.userAgent.toLowerCase(), e = function (t) {
        ...
        if (this.isArray(t = t || [])) for (e = 0; e < t.length && !o(e, t); e++) ; else for (e in t) if (o(e, t)) break;
        return this
...
!function (s) {
    ...
    r.fn = r.prototype = [], r.fn.constructor = r, h.extend = function () {
        ...
        if (e = "object" == typeof e ? e : {attr: e}, t === l) return {};
...
layui.define(function (e) {
    ...
    var r = document, u = "getElementById", c = "getElementsByTagName", a = "layui-disabled", t = function (e) {
        ...
        var t, i, n = this.config, r = n.groups = "groups" in n ? Number(n.groups) || 0 : 5,
...
!function (i, v) {
    ...
    s.formatArr = function (e) {
        ...
        var t, o, d = this, s = (new Date, d.config), a = d.lang(), n = s.dateTime = s.dateTime || d.systemDate(),
            i = s.elem[0], l = (d.isInput(i), function () {
                if (d.rangeElem) {
    ...
    var s = layui.$, a = layui.hint(), i = {
        fixbar: function (o) {
            var i, e, t, n, a = "layui-fixbar", r = s(document), l = (o = s.extend(!0, {
                    ...
                    margin: 160,
                    duration: 320
                }, o), s(o.target)), c = o.scroll ? s(o.scroll) : s("body" === o.target ? r : l),
                u = (o["default"] && (o.bar1 && o.bars.push({
                    type: "bar1",
                    icon: "layui-icon-chat"
                }), o.bar2 && o.bars.push({type: "bar2", icon: "layui-icon-help"}), o.bars.push({
                    type: "top",
                    icon: "layui-icon-top"
                })), s("<ul>").addClass(a));
            layui.each(o.bars, function (e, t) {
                ...
                n.addClass(t.icon).attr({
                    ...
                    "top" === e && ("body" === o.target ? s("html,body") : c).animate({scrollTop: 0}, o.duration), "function" == typeof o.click && o.click.call(this, e)
            ...
            o = s.extend(!0, {date: new Date, now: new Date}, o);
            var i = arguments, a = (1 < i.length && (o.date = new Date(i[0]), o.now = new Date(i[1]), o.clock = i[2]), {
                options: o,
                clear: function () {
                    clearTimeout(a.timer)
                },
                reload: function (e) {
                    this.clear(), s.extend(!0, this.options, {now: new Date}, e), r()
                }
            }), r = ("function" == typeof o.ready && o.ready(), function l() {
                var e = new Date(o.date), t = new Date(o.now), e = 0 < (e = e.getTime() - t.getTime()) ? e : 0, n = {
            ...
            var n = this, o = [[], []], i = (new Date).getTime() - new Date(e).getTime();
            ...
            var n = this, o = new Date(function () {
                ...
                }() || new Date), i = [n.digit(o.getFullYear(), 4), n.digit(o.getMonth() + 1), n.digit(o.getDate())],
...
layui.define(["jquery", "laytpl", "lay"], function (e) {
    "use strict";
    var n, i, t, s = layui.$, c = layui.laytpl, a = layui.hint(),
        o = layui.device().mobile ? "touchstart" : "mousedown", r = "dropdown", m = "layui_" + r + "_index", p = {
        ...
        }, f = "layui-dropdown", l = "layui-menu-item-up", d = "layui-menu-item-down", h = "layui-menu-body-title",
        u = "layui-menu-item-group", g = "layui-menu-item-parent", v = "layui-menu-item-checked",
        w = "layui-menu-item-checked2", C = "layui-menu-body-panel", V = "layui-menu-body-panel-left",
        x = "layui-dropdown-shade", b = "." + u + ">." + h, k = function (e) {
            var i = this;
    ...
    k.prototype.config = {
        ...
        var l = this, d = l.config, t = s("body"), n = function () {
                ...
                return layui.each(e, function (e, i) {
                    var t, n = i.child && 0 < i.child.length, a = ("isSpreadItem" in i ? i : d).isSpreadItem,
        ...
        !(e = "contextmenu" !== d.trigger && !lay.isTopElem(d.elem[0]) ? e : !0) && d.elem.data(m + "_opened") || (l.elemView = s("." + f + '[lay-id="' + d.id + '"]'), "reloadData" === i && l.elemView.length ? l.elemView.html(d.content || n()) : (l.elemView = s(a), l.elemView.append(d.content || n()), d.className && l.elemView.addClass(d.className), d.style && l.elemView.attr("style", d.style), p.thisId = d.id, l.remove(), t.append(l.elemView), d.elem.data(m + "_opened", !0), e = d.shade ? '<div class="' + x + '" style="z-index:' + (l.elemView.css("z-index") - 1) + "; background-color: " + (d.shade[1] || "#000") + "; opacity: " + (d.shade[0] || d.shade) + '"></div>' : "", l.elemView.before(e), "mouseenter" === d.trigger && l.elemView.on("mouseenter", function () {
            ...
            var i = s(this), t = i.data("item") || {}, n = t.child && 0 < t.child.length, a = "all" === d.clickScope;
        ...
        var i = e.hasClass(l), t = e.children("." + h).find(".layui-icon-" + (i ? "down" : "up"));
        i ? (e.removeClass(l).addClass(d), t.removeClass("layui-icon-down").addClass("layui-icon-up")) : (e.removeClass(d).addClass(l), t.removeClass("layui-icon-up").addClass("layui-icon-down"))
        ...
        var i = s(this), t = i.parents(".layui-menu").eq(0), n = i.hasClass(u) || i.hasClass(g),
        ...
        var i = s(this).parents("." + u + ":eq(0)"), t = lay.options(i[0]);
...
layui.define("jquery", function (t) {
    "use strict";
    var u = layui.$, d = (layui.hint(), layui.device()), o = "element", c = "layui-this", h = "layui-show",
        r = ".layui-tab-title", i = function () {
            this.config = {}
            ...
            var a, e = u(".layui-tab[lay-filter=" + t + "]"), l = e.children(r), n = l.children(".layui-tab-bar"),
            ...
            t = u(".layui-tab[lay-filter=" + t + "]").children(r).find('>li[lay-id="' + i + '"]');
            return g.tabClick.call(t[0], {liElem: t}), this
        }, i.prototype.tab = function (a) {
            a = a || {}, e.on("click", a.headerElem, function (t) {
                var i = u(this).index();
                g.tabClick.call(this, {index: i, options: a})
            })
        ...
        v = "layui-nav-more", m = "layui-anim layui-anim-upbit", g = {
            tabClick: function (t) {
                ...
                i.hasClass(c) && (i.next()[0] && i.next().is("li") ? g.tabClick.call(i.next()[0], {index: a + 1}) : i.prev()[0] && i.prev().is("li") && g.tabClick.call(i.prev()[0], null, a - 1)), i.remove(), l.eq(a).remove(), setTimeout(function () {
                    g.tabAuto()
                }, 50), layui.event.call(this, o, "tabDelete(" + n + ")", {elem: e, index: a})
            }, tabAuto: function (l) {
                ...
                var t = u(this), i = t.parents(y), a = i.attr("lay-filter"), e = t.parent(), l = t.siblings("." + b),
...
layui.define(["lay", "layer"], function (e) {
    "use strict";
    var x = layui.$, i = layui.layer, b = layui.device(), t = {
        ...
        w = "layui-upload-choose", L = function (e) {
            var i = this;
    ...
    L.prototype.config = {
        ...
        var t, n, a, o, r = this, u = r.config, c = u.text || {}, l = r.elemFile[0], f = function () {
            ...
            var i = 0, a = 0, o = f(), l = function () {
                ...
                var n = new FormData, e = (layui.each(u.data, function (e, i) {
            ...
            u.unified ? t({unified: !0, index: 0}) : layui.each(o, function (e, i) {
                t({index: e, file: i})
            })
        }, p = function () {
            var n = x("#" + F);
        ...
        }, h = u.exts, g = (n = [], layui.each(e || r.chooseFiles, function (e, i) {
            n.push(i.name)
        }), n), v = {
            preview: function (e) {
                r.preview(e)
        ...
        if (0 !== g.length) {
            ...
            if ("choose" !== i && !u.auto || (u.choose && u.choose(v), "choose" !== i)) {
                ...
                if (0 < u.size && !(b.ie && b.ie < 10)) if (layui.each(f(), function (e, i) {
        ...
        var n = this, a = n.config, o = function (e) {
            ...
            var e = x(this);
            (e.attr("lay-data") || e.attr("lay-options")) && (n.config = x.extend({}, a, lay.options(this, {attr: e.attr("lay-data") ? "lay-data" : null})))
        };
        a.elem.off("upload.start").on("upload.start", function () {
            ...
            var e = this.files || [];
            0 !== e.length && (r.call(this), o(e), a.auto ? n.upload() : l(e))
...
layui.define(["lay", "layer", "util"], function (e) {
    "use strict";
    var C = layui.$, y = layui.layer, d = layui.util, n = layui.hint(), w = (layui.device(), "form"), o = ".layui-form",
        T = "layui-this", N = "layui-hide", $ = "layui-disabled", t = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "\u5fc5\u586b\u9879\u4e0d\u80fd\u4e3a\u7a7a"],
                ...
                }, verIncludeRequired: !1, autocomplete: null
            }
            ...
            var i = this.config, a = C(o + (t ? '[lay-filter="' + t + '"]' : "")), l = {
                input: function (e) {
                            ...
                            u = "layui-input-affix", e = r.is("[disabled]") || r.is("[readonly]"), d = function (e, t) {
                                ...
                                eye: {
                                    value: "eye-invisible", click: function (e, t) {
                                        ...
                                        e.attr("type", a ? "password" : "text").data(i, !a), l({value: a ? "eye-invisible" : "eye"})
                                    }
                                },
                                clear: {
                                ...
                                number: {
                                    ...
                                    click: function (e) {
                                        var t = C(this).index(), i = e.val(), a = i, l = Number(e.attr("step")) || 1,
                                            n = Number(e.attr("min")), r = Number(e.attr("max"));
                                        isNaN(i) || (i = Number(i), r < (i = (i = t ? i - l : i + l) < n ? n : i) && (i = r), t = function (e) {
                                            return ((e.toString().match(/\.(\d+$)/) || [])[1] || "").length
                                        }, (n = Math.max(t(l), t(a))) && (i = i.toFixed(n)), e.val(i))
                                    }
                                }
                            };
                        l()
                    ...
                    var p, c = "\u8bf7\u9009\u62e9", m = "layui-form-select", g = "layui-select-title",
                        x = "layui-select-none", k = "", e = e || a.find("select"), b = function (e, t) {
                            ...
                            var s, r, i, l, o, n, c = C(this), u = a.find("." + g), d = u.find("input"), f = a.find("dl"),
                            ...
                            e || (r = c.attr("lay-search"), i = function () {
                                ...
                                var n = 0, t = (layui.each(h, function () {
                    ...
                    e.each(function (e, t) {
                        var i = C(this), a = i.next("." + m), l = this.disabled, n = t.value,
                    ...
                    e.each(function (e, t) {
                        var i = C(this), a = i.attr("lay-skin") || "primary",
                            l = d.escape(C.trim(t.title || (t.title = i.attr("lay-text") || ""))), n = this.disabled,
                        ...
                        i.after(n), function (a, l) {
                            var n = C(this);
                            a.on("click", function () {
                                var e = C(this), t = n.attr("lay-filter"),
                                    e = e.next("*[lay-checkbox]")[0] ? e.next().html() : n.attr("title") || "",
                                    i = n.attr("lay-skin") || "primary", e = "switch" === i ? e.split("|") : [e];
                    ...
                    e.each(function (e, t) {
                        var i = C(this), a = i.next("." + r), l = this.disabled;
                        if ("string" == typeof i.attr("lay-ignore")) return i.show();
                        a[0] && a.remove();
                        ...
                        i.after(l), function (a) {
                            var l = C(this), n = "layui-anim-scaleSpring";
                            a.on("click", function () {
                                var e = l[0].name, t = l.parents(o), i = l.attr("lay-filter"),
                                    e = t.find("input[name=" + e.replace(/(\.|#|\[|\])/g, "\\$1") + "]");
                                l[0].disabled || (layui.each(e, function () {
                                    var e = C(this).next("." + r);
                                    this.checked = !1, e.removeClass(r + "ed"), e.children(".layui-icon").removeClass(n + " " + s[0]).addClass(s[1])
                                }), l[0].checked = !0, a.addClass(r + "ed"), a.children(".layui-icon").addClass(n + " " + s[0]), layui.event.call(l[0], w, "radio(" + i + ")", {
                                    elem: l[0],
                                    value: l[0].value,
                                    othis: a
                                }))
            ...
            var u = null, d = this.config, f = d.verify, h = "layui-form-danger";
                ...
                if (s.removeClass(h), layui.each(t, function (e, t) {
                    ...
                    if (a) {
                        var l = "function" == typeof a ? i = a(c, r) : !a[0].test(c),
                            n = "select" === r.tagName.toLowerCase() || /^(checkbox|radio)$/.test(r.type), i = i || a[1];
                        if ("required" === t && (i = s.attr("lay-reqtext") || i), l && (d.verIncludeRequired || "required" === t || c && "required" !== t)) return "tips" === o ? y.tips(i, "string" != typeof s.attr("lay-ignore") && n ? s.next() : s, {tips: 1}) : "alert" === o ? y.alert(i, {
                            title: "\u63d0\u793a",
                            shadeClose: !0
                        }) : /\b(string|number)\b/.test(typeof i) && y.msg(i, {icon: 5, shift: 6}), setTimeout(function () {
            ...
            var i = C(this), e = "string" == typeof e ? e : i.attr("lay-filter"),
                a = this.getFormElem ? this.getFormElem(e) : i.parents(o).eq(0), l = a.find("*[lay-verify]");
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (n) {
    "use strict";
    var p = layui.$, r = layui.lay, m = layui.laytpl, z = layui.laypage, f = layui.layer, v = layui.form,
        g = layui.util, y = layui.hint(), b = layui.device(), x = {
            config: {
            ...
            return t && (i = "function" == typeof t ? t.call(a, e.tplData, e.obj) : m(p(t).html() || String(i)).render(p.extend({LAY_COL: a}, e.tplData))), e.text ? p("<div>" + i + "</div>").text() : i
        }, T = "table", t = ".layui-table", N = "layui-hide", h = "layui-hide-v", L = "layui-none", R = "layui-table-view",
        o = ".layui-table-header", D = ".layui-table-body", _ = ".layui-table-pageview", A = ".layui-table-sort",
        E = "layui-table-checked", W = "layui-table-edit", j = "layui-table-hover", H = "laytable-cell-group",
        M = "layui-table-col-special", S = "layui-table-tool-panel", I = "LAY_TABLE_MOVE_DICT", e = function (e) {
        ...
        O = p(window), P = p(document), i = function (e) {
            ...
            var t = this, a = t.layMain.find("." + L), e = p('<div class="' + L + '">' + (e || "Error") + "</div>");
            ...
            return n = n || 1, layui.each(a, function (e, o) {
                ...
                "array" === layui.type(o) && 0 === o.length || (o[x.config.numbersName] = c, l || (o[x.config.indexName] = e), s.eachCols(function (e, l) {
                    ...
                    n !== undefined && null !== n || (n = ""), l.colGroup || (t = ['<td data-field="' + e + '" data-key="' + a + '" ' + (e = [], (t = "function" == typeof l.edit ? l.edit(o) : l.edit) && e.push('data-edit="' + t + '"'), l.templet && e.push('data-content="' + g.escape(n) + '"'), l.toolbar && e.push('data-off="true"'), l.event && e.push('lay-event="' + l.event + '"'), l.minWidth && e.push('data-minwidth="' + l.minWidth + '"'), l.maxWidth && e.push('data-maxwidth="' + l.maxWidth + '"'), e.join(" ")) + ' class="' + (t = [], l.hide && t.push(N), l.field || t.push(M), t.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? a : a + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + (e = [], l.style && e.push('style="' + l.style + '"'), e.join(" ")) + ">" + function () {
                        var e, t = p.extend(!0, {LAY_COL: l}, o), a = x.config.checkName, i = x.config.disabledName;
                        switch (l.type) {
                            case"checkbox":
            ...
            c.totalRow && (layui.each(e, function (e, i) {
                ...
                var a, e = t.field || e, i = o && o[t.field], l = "totalRowDecimals" in t ? t.totalRowDecimals : 2,
                    ...
                    l = (a = t.totalRowText || "", (n = {LAY_COL: t})[e] = l, n = t.totalRow && w.call(r, {
                        item3: t,
                        content: l,
                        tplData: n
            ...
            var e = this, i = e.config,
                ...
                t = (a = p.extend({type: "checkbox"}, a), x.cache[e.key]), n = "checked" in a, o = function (e) {
            ...
            t.sortKey = {
                ...
                field: d,
                type: l.type
            }, layui.event.call(l.field, T, "sort(" + n + ")", p.extend({config: i}, i.initSort)))
            ...
            e.layFixed.find(D).css("height", t.height() >= n ? n : "auto").scrollTop(e.layMain.scrollTop()), e.layFixRight[x.cache[e.key] && x.cache[e.key].length && 0 < l ? "removeClass" : "addClass"](N), e.layFixRight.css("right", a - 1)
        }, i.prototype.events = function () {
            var s = this, u = s.config, r = u.elem.attr("lay-filter"), e = s.layHeader.find("th"), y = ".layui-table-cell",
                o = p("body"), d = {}, c = (s.layTool.on("click", "*[lay-event]", function (e) {
                    var a, i = p(this), t = i.attr("lay-event"), l = function (e) {
                        var t = p(e.list), a = p('<ul class="' + S + '"></ul>');
                    ...
                    switch (layui.stope(e), P.trigger("table.tool.panel.remove"), f.close(s.tipsIndex), t) {
                        ...
                        case"LAYTABLE_EXPORT":
                            b.ie ? f.tips("\u5bfc\u51fa\u529f\u80fd\u4e0d\u652f\u6301 IE\uff0c\u8bf7\u7528 Chrome \u7b49\u9ad8\u7ea7\u6d4f\u89c8\u5668\u5bfc\u51fa", this, {tips: 3}) : l({
                    ...
                    layui.event.call(this, T, "toolbar(" + r + ")", p.extend({event: t, config: u}, {}))
                }), s.layHeader.on("click", "*[lay-event]", function (e) {
                    var t = p(this), a = t.attr("lay-event"), t = t.closest("th").data("key"), t = s.col(t);
                    layui.event.call(this, T, "colTool(" + r + ")", p.extend({event: a, config: u, col: t}, {}))
                }), s.layPagebar.on("click", "*[lay-event]", function (e) {
                    var t = p(this).attr("lay-event");
                    layui.event.call(this, T, "pagebar(" + r + ")", p.extend({event: t, config: u}, {}))
                    ...
                    var t = p(this).parents("tr").eq(0).data("index"), r = s.layBody.find('tr[data-index="' + t + '"]'),
                        c = (c = x.cache[s.key] || [])[t] || {}, a = {
                            tr: r, config: u, data: x.clearCacheKey(c), dataCache: c, index: t, del: function () {
                    ...
                    var e = p(this), t = e.parent(), a = this.value, i = e.parent().data("field"),
                        e = e.closest("tr").data("index"), e = x.cache[s.key][e], l = c.call(t[0], {
            ...
            return e.each(function () {
                var l, e = p(this), t = e.attr("lay-data"),
                    ...
                    }, x.config, o, t), a = (i && e.hide(), e.find("thead>tr").each(function (i) {
    ...
    x.eachCols = function (e, a, i) {
        var e = k.config[e] || {}, l = [], n = (i = p.extend(!0, [], i || e.cols), layui.each(i, function (a, e) {
            if (a) return !0;
            layui.each(e, function (e, t) {
        ...
        var o, d, i, r, l = (a = "object" == typeof a ? a : (l = {}, a && (l.type = a), l)).type || "csv",
            c = k.that[e], n = k.config[e] || {}, s = {csv: "text/csv", xls: "application/vnd.ms-excel"}[l],
...
layui.define(["table"], function (e) {
    "use strict";
    var B = layui.$, x = layui.form, j = layui.table, y = layui.hint(), P = {
            config: {}, on: j.on, eachCols: j.eachCols, index: j.index, set: function (e) {
                var t = this;
                return t.config = B.extend({}, t.config, e), t
            }, resize: j.resize, getOptions: j.getOptions, hideCol: j.hideCol, renderData: j.renderData
        }, i = function () {
        ...
        }, q = "layui-hide", L = ".layui-table-main", R = ".layui-table-fixed-l", Y = ".layui-table-fixed-r",
        l = "layui-table-checked", h = "layui-table-tree", H = "LAY_DATA_INDEX", m = "LAY_DATA_INDEX_HISTORY",
        s = "LAY_PARENT_INDEX", b = "LAY_CHECKBOX_HALF", X = "LAY_EXPAND", z = "LAY_HAS_EXPANDED",
        V = "LAY_ASYNC_STATUS", t = function (e) {
            var t = this;
            ...
            layui.each(e || l, function (e, t) {
                var a = t[H];
                -1 !== a.indexOf("-") && (l[a] = t), t[i] && u(n, i, t[i])
            })
        }, r = function (i, a, e) {
            var l = F(i), t = ("reloadData" !== e && (l.status = {expand: {}}), B.extend(!0, {}, l.getOptions(), a)),
                n = t.tree, r = n.customName.children, d = n.customName.id,
            ...
            t.url ? e && (!o || o.mod) || (a.parseData = function () {
                ...
                return n.data.isSimpleData && !n["async"].enable && (a[t] = l.flatToTree(a[t])), f(a[t], function (e) {
                ...
                var e, t = arguments, a = (t[3] || delete l.isExpandAll, this.elem.next()),
                    n = (l.updateStatus(null, {LAY_HAS_EXPANDED: !1}), u(i, r), a.find('[name="layTableCheckbox"][lay-filter="layTableAllChoose"]'));
    ...
    t.prototype.init = function () {
        var e = this.config, t = e.tree.data.cascade,
            t = ("parent" !== t && "children" !== t && (e.tree.data.cascade = "all"), j.render(B.extend({}, e, {
                data: [],
                url: "",
                done: null
            }))), a = t.config.id;
        (i.that[a] = this).tableIns = t, r(a, e)
    }, t.prototype.config = {
        tree: {
            customName: {
                children: "children",
        ...
        var l = this, r = l.getOptions().tree.customName, d = r.children, o = r.pid, c = [];
        return layui.each(e, function (e, t) {
            var e = (i ? i + "-" : "") + e, a = B.extend({}, t);
            a[o] = t[o] || n, c.push(a), c = c.concat(l.treeToFlat(t[d], t[r.id], e))
        }), c
    }, t.prototype.getTreeNode = function (e) {
        var t = this;
        if (!e) return y.error("\u627e\u4e0d\u5230\u8282\u70b9\u6570\u636e");
        var a = t.getOptions(), n = a.tree;
        a.id, n.customName;
        return {
            data: e, dataIndex: e[H], getParentNode: function () {
                return t.getNodeByIndex(e[s])
            }
        }
    }, t.prototype.getNodeByIndex = function (t) {
        var e = this, a = e.getNodeDataByIndex(t);
        if (!a) return y.error("\u627e\u4e0d\u5230\u8282\u70b9\u6570\u636e");
        var n = e.getOptions(), i = (n.tree.customName.parent, n.id), n = {
            data: a, dataIndex: a[H], getParentNode: function () {
                return e.getNodeByIndex(a[s])
            }, update: function (e) {
                return P.updateNode(i, t, e)
            }, remove: function () {
                return P.removeNode(i, t)
            }, expand: function (e) {
                return P.expandNode(i, B.extend({}, e, {index: t}))
            }, setChecked: function (e) {
                return P.setRowChecked(i, B.extend({}, e, {index: t}))
            }
        };
        return n.dataIndex = t, n
    }, t.prototype.getNodeById = function (a) {
        var e = this.getOptions(), n = e.tree.customName.id, i = "", e = P.getData(e.id, !0);
        ...
        var n = this.getOptions(), i = n.tree, l = n.id, r = j.cache[l][a];
    ...
    t.prototype.initData = function (e, a) {
        var n = this, t = n.getOptions(), i = t.tree, t = t.id, i = (e = e || n.getTableData(), i.customName),
            l = i.isParent, r = i.children;
        return layui.each(e, function (e, t) {
            l in t || (t[l] = !(!t[r] || !t[r].length)), t[m] = t[H], t[s] = a = a || "";
            e = t[H] = (a ? a + "-" : "") + e;
            n.initData(t[r] || [], e)
        }), u(t, r, e), e
    }, n = {};
    var n, U = function (e, t, a) {
        ...
        var e = t.trElem, r = t.tableViewElem || e.closest(".layui-table-view"), d = t.tableId || r.attr("lay-id"),
            o = t.options || j.getOptions(d), e = t.dataIndex || e.attr("lay-data-index"), c = F(d), u = o.tree || {},
            s = u.customName || {}, f = s.isParent, y = c.getNodeDataByIndex(e), p = "boolean" !== layui.type(a),
            x = p ? !y[X] : a, h = y[f] ? x : null;
        if (l && x != y[X] && (!y[V] || "local" === y[V])) {
            var m = u.callback.beforeExpand;
            if ("function" === layui.type(m) && !1 === m(d, y, a)) return h
        }
        var m = y[z], b = r.find('tr[lay-data-index="' + e + '"]'), g = b.find(".layui-table-tree-flexIcon"),
        ...
        v = y[s.children] || [];
        if (x) if (m) b.nextAll(v.map(function (e, t, a) {
            ...
            var N, C, b = u["async"] || {}, I = b.url || o.url;
            if (b.enable && y[f] && !y[V]) {
                ...
                var k = B.extend({}, b.where || o.where), T = b.autoParam, T = (layui.each(T, function (e, t) {
                        t = t.split("=");
                        k[t[0].trim()] = y[(t[1] || t[0]).trim()]
                    }), b.contentType || o.contentType),
                    _ = (T && 0 == T.indexOf("application/json") && (k = JSON.stringify(k)), b.method || o.method),
                    w = b.dataType || o.dataType, O = b.jsonpCallback || o.jsonpCallback, S = b.headers || o.headers,
                    A = b.parseData || o.parseData, E = b.response || o.response;
                return B.ajax({
                    type: _ || "get",
                    url: I,
                    contentType: T,
            ...
            m = y[z] = !0, v.length && (!o.initSort || o.url && !o.autoSort || ((b = o.initSort).type ? layui.sort(v, b.field, "desc" === b.type, !0) : layui.sort(v, j.config.indexName, null, !0)), c.initData(y[s.children], y[H]), _ = j.getTrHtml(d, v, null, null, e), N = {
                trs: B(_.trs.join("")),
                trs_fixed: B(_.trs_fixed.join("")),
                trs_fixed_r: B(_.trs_fixed_r.join(""))
            }, C = (e.split("-").length - 1 || 0) + 1, layui.each(v, function (e, t) {
                N.trs.eq(e).attr({
                    "data-index": t[H],
                    "lay-data-index": t[H],
                    "data-level": C
                    ...
                    "lay-data-index": t[H],
                    "data-level": C
                }), N.trs_fixed_r.eq(e).attr({"data-index": t[H], "lay-data-index": t[H], "data-level": C})
            }), r.find(L).find('tbody tr[lay-data-index="' + e + '"]').after(N.trs), r.find(R).find('tbody tr[lay-data-index="' + e + '"]').after(N.trs_fixed), r.find(Y).find('tbody tr[lay-data-index="' + e + '"]').after(N.trs_fixed_r), c.renderTreeTable(N.trs, C), n && !p && layui.each(v, function (e, t) {
                J({
                    dataIndex: t[H],
                    trElem: r.find('tr[lay-data-index="' + t[H] + '"]').first(),
                    tableViewElem: r,
            ...
            return 'tr[lay-data-index="' + e[H] + '"]'
        }).join(",")).addClass(q)) : (I = c.treeToFlat(v, y[s.id], e), r.find(I.map(function (e, t, a) {
            return 'tr[lay-data-index="' + e[H] + '"]'
        }).join(",")).addClass(q));
        ...
        var a, n, i, e = F(e);
        if (e) return a = (t = t || {}).index, n = t.expandFlag, i = t.inherit, t = t.callbackFlag, e = e.getOptions().elem.next(), J({trElem: e.find('tr[lay-data-index="' + a + '"]').first()}, n, i, null, t)
    }, P.expandAll = function (a, e) {
        if ("boolean" !== layui.type(e)) return y.error("expandAll \u7684\u5c55\u5f00\u72b6\u6001\u53c2\u6570\u53ea\u63a5\u6536true/false");
        var t = F(a);
        if (t) {
            t.isExpandAll = e;
            var n = t.getOptions(), i = n.tree, l = n.elem.next(), r = i.customName.isParent, d = i.customName.id,
            ...
            if (e) {
                ...
                if (i["async"].enable) {
                    ...
                    if (layui.each(e, function (e, t) {
                        ...
                        P.expandNode(a, {index: t[H], expandFlag: !0, inherit: !0})
                    })
                }
                var u = !0;
                if (layui.each(e, function (e, t) {
                ...
                }), l.find('tbody tr[data-level!="0"]').removeClass(q), l.find(".layui-table-tree-flexIcon").html(i.view.flexIconOpen), i.view.showIcon && l.find(".layui-table-tree-nodeIcon:not(.layui-table-tree-iconCustom,.layui-table-tree-iconLeaf)").html(i.view.iconOpen); else {
        ...
        var n = this, i = n.getOptions(), l = i.elem.next(), r = (l.hasClass(h) || l.addClass(h), i.id),
            d = i.tree || {}, o = (d.data, d.view || {}), c = d.customName || {}, u = c.isParent,
        ...
        var e = a.getOptions(), t = e.elem.next(), n = 0, i = t.find(".layui-table-main tbody tr"),
            l = t.find(".layui-table-fixed-l tbody tr"), r = t.find(".layui-table-fixed-r tbody tr");
    ...
    }), f = (t.prototype.render = function (e) {
        var t = this;
        ...
        }), r(n.getOptions().id, e, a || !0), n.config = B.extend(t, {}, n.config, e), n.render(a)
    }, P.reloadData = function () {
        ...
        var l = [];
        return layui.each(e, function (e, t) {
            "function" === layui.type(a) ? a(t) : B.extend(t, a), l.push(B.extend({}, t)), i || (l = l.concat(f(t[n], a, n, i)))
        }), l
    }), d = (t.prototype.updateStatus = function (e, t, a) {
        var n = this.getOptions(), i = n.tree;
        return e = e || j.cache[n.id], f(e, t, i.customName.children, a)
    }, t.prototype.getTableData = function () {
        var e = this.getOptions();
        return e.url ? j.cache[e.id] : e.data
    }, P.updateStatus = function (e, t, a) {
        var e = F(e), n = e.getOptions();
        return a = a || (n.url ? j.cache[n.id] : n.data), e.updateStatus(a, t)
    }, P.sort = function (e) {
        var t, a = F(e);
        !a || (t = a.getOptions()).url && !t.autoSort || (a.initData(), P.renderData(e))
    }, function (n) {
        var t = n.config.id, i = F(t), a = n.data = P.getNodeDataByIndex(t, n.index), l = a[H],
            r = (n.dataIndex = l, n.update);
        n.update = function () {
            var e = arguments, t = (B.extend(i.getNodeDataByIndex(l), e[0]), r.apply(this, e)),
            ...
            P.setRowChecked(t, {index: a, checked: e})
        }
        ...
        var a, n, i, l, r, d = F(e);
        d && (r = (a = d.getOptions()).tree, n = a.elem.next(), i = [], t = d.getNodeDataByIndex("string" === layui.type(t) ? t : t[H], !1, "delete"), l = d.getNodeDataByIndex(t[s]), d.updateCheckStatus(l), l = d.treeToFlat([t], t[r.customName.pid], t[s]), layui.each(l, function (e, t) {
        ...
        var a = F(e);
        if (a) {
            var n = a.getOptions(), i = n.tree, l = n.elem.next(), r = (t = t || {}).parentIndex, d = t.index,
                o = t.data, t = t.focus,
                c = (r = "number" === layui.type(r) ? r.toString() : r) ? a.getNodeDataByIndex(r) : null,
                d = "number" === layui.type(d) ? d : -1, o = B.extend(!0, [], layui.isArray(o) ? o : [o]);
            a.getTableData();
            if (c) {
                var u = i.customName.isParent, s = i.customName.children;
                c[u] = !0;
                ...
                l.find(s.map(function (e) {
                    return 'tr[lay-data-index="' + e[H] + '"]'
                }).join(",")).remove(), a.initData(), c[z] = !1, c[V] = "local", J({trElem: l.find('tr[lay-data-index="' + r + '"]')}, !0)
            } else {
                ...
                }), parseInt(o[0][H]) - 1), f = l.find(L), n = l.find(R), s = l.find(Y);
                -1 == r ? (f.find('tr[data-level="0"][data-index="0"]').before(x.trs), n.find('tr[data-level="0"][data-index="0"]').before(x.trs_fixed), s.find('tr[data-level="0"][data-index="0"]').before(x.trs_fixed_r)) : -1 === d ? (f.find("tbody").append(x.trs), n.find("tbody").append(x.trs_fixed), s.find("tbody").append(x.trs_fixed_r)) : (r = y[0][m], f.find('tr[data-level="0"][data-index="' + r + '"]').before(x.trs), n.find('tr[data-level="0"][data-index="' + r + '"]').before(x.trs_fixed), s.find('tr[data-level="0"][data-index="' + r + '"]').before(x.trs_fixed_r)), layui.each(j.cache[e], function (e, t) {
        ...
        var i, t, a, l = F(e);
        if (l) return l = l.getOptions().tree, i = j.config.checkName, t = P.getData(e, !0).filter(function (e, t, a) {
            return e[i] || n && e[b]
        }), a = !0, layui.each("all" === l.data.cascade ? j.cache[e] : P.getData(e, !0), function (e, t) {
            if (!t[i]) return !(a = !1)
        }), {data: t, isAll: a}
        ...
        e.config.elem.next().hasClass(h) && d(e)
    }), P.on("rowDouble", function (e) {
        var t = e.config, a = t.elem.next();
        t.id;
        a.hasClass(h) && (d(e), (t.tree || {}).view.dblClickExpand && J({trElem: e.tr.first()}, null, null, null, !0))
        ...
        var t = e.config, a = t.elem.next();
        t.id;
        a.hasClass(h) && (d(e), e.field === t.tree.customName.name && ((a = {})[e.field] = e.value, e.update(a)))
    }), P.on("radio", function (e) {
        var t = e.config, a = t.elem.next(), t = t.id;
        a.hasClass(h) && (a = F(t), d(e), o.call(a, e.tr, e.checked))
        ...
        e[t ? "addClass" : "removeClass"](l), e.each(function () {
            var e = B(this).data("index");
            n.find('.layui-table-fixed-r tbody tr[data-index="' + e + '"]')[t ? "addClass" : "removeClass"](l)
        })
    }, t.prototype.updateCheckStatus = function (e, t) {
        var i = this, a = i.getOptions(), n = a.tree, l = a.id, r = a.elem.next(), d = j.config.checkName,
            a = n.data.cascade,
            o = (("all" === a || "parent" === a) && e && (a = i.updateParentCheckStatus(e, "boolean" === layui.type(t) ? t : null), layui.each(a, function (e, t) {
                var a = r.find('tr[lay-data-index="' + t[H] + '"]  input[name="layTableCheckbox"]:not(:disabled)'),
                    n = t[d];
                i.setRowCheckedClass(a.closest("tr"), n), x.render(a.prop({checked: n, indeterminate: t[b]}))
            })), !0), c = !1;
        return layui.each("all" === n.data.cascade ? j.cache[l] : P.getData(l, !0), function (e, t) {
            if ((t[d] || t[b]) && (c = !0), t[d] || (o = !1), c && !o) return !0
        }), c = c && !o, x.render(r.find('input[name="layTableCheckbox"][lay-filter="layTableAllChoose"]').prop({
            checked: o,
            indeterminate: c
        })), o
        ...
        return !(a[b] = !1) === n ? a[t].length ? layui.each(a[t], function (e, t) {
            ...
            t[l] && i++
        }), n = a[t].length ? a[t].length === i : a[l], a[b] = !n && 0 < i), a[l] = n, r.push(B.extend({}, a)), r = a[s] ? r.concat(this.updateParentCheckStatus(j.cache[e][a[s]], n)) : r
    }, function (e, t, a) {
        var n = this, i = n.getOptions(), l = i.tree, r = i.id, d = i.elem.next(),
            o = (e.length ? e : d).find(".laytable-cell-radio, .laytable-cell-checkbox").children("input").last(),
            i = "radio" === o.attr("type");
        if (a) {
            a = function () {
                var e = function (e) {
            ...
            if (!i) return t = "boolean" === layui.type(t) ? t : !a[u], i = n.updateStatus(a ? [a] : j.cache[r], function (e) {
                e[j.config.disabledName] || (e[u] = t, e[b] = !1)
            }, a && "parent" === l.data.cascade), r = d.find(i.map(function (e) {
                return 'tr[lay-data-index="' + e[H] + '"] input[name="layTableCheckbox"]:not(:disabled)'
            }).join(",")), n.setRowCheckedClass(r.closest("tr"), t), x.render(r.prop({
                checked: t,
                indeterminate: !1
            })), a && a[s] && (c = n.getNodeDataByIndex(a[s])), n.updateCheckStatus(c, t);
            a && (n.updateStatus(null, function (e) {
                var t;
                e[u] && (t = d.find('tr[lay-data-index="' + e[H] + '"] input[type="radio"][lay-type="layTableRadio"]'), e[u] = !1, n.setRowCheckedClass(t.closest("tr"), !1), x.render(t.prop("checked", !1)))
    ...
    P.on("checkbox", function (e) {
        ...
        !i || (t = i.getOptions().tree)["async"] && t["async"].enable && ((n = i.getNodeDataByIndex(e)) && (n[z] = !1, n[X] = !1, n[V] = !1, layui.each(i.treeToFlat(n[t.customName.children]).reverse(), function (e, t) {
            P.removeNode(a, t[H])
        }), P.expandNode(a, {index: e, expandFlag: !0, callbackFlag: !0})))
...
layui.define("form", function (e) {
    "use strict";
    var h = layui.$, i = layui.form, p = layui.layer, a = "tree", n = {
            ...
            return t.that[a] = i, {
                config: t.config[a] = e, reload: function (e) {
                    i.reload.call(i, e)
                }, getChecked: function () {
        ...
        }, y = "layui-hide", o = "layui-disabled", f = "layui-tree-set", k = "layui-tree-iconClick",
        C = "layui-icon-addition", v = "layui-icon-subtraction", m = "layui-tree-entry", x = "layui-tree-main",
        b = "layui-tree-txt", g = "layui-tree-pack", w = "layui-tree-spread", F = "layui-tree-setLineShort",
        T = "layui-tree-showLine", N = "layui-tree-lineExtend", l = function (e) {
            var i = this;
            i.index = ++n.index, i.config = h.extend({}, i.config, n.config, e), i.render()
        };
    l.prototype.config = {
        data: [],
        showCheckbox: !1,
        ...
        }), a.config = h.extend(!0, {}, a.config, e), a.render()
    }, l.prototype.render = function () {
        var e = this, i = e.config,
            a = (e.checkids = [], h('<div class="layui-tree' + (i.showCheckbox ? " layui-form" : "") + (i.showLine ? " layui-tree-line" : "") + '" lay-filter="LAY-tree-' + e.index + '"></div>')),
            n = (e.tree(a), i.elem = h(i.elem));
        if (n[0]) {
            if (e.key = i.id || e.index, e.elem = a, e.elemNone = h('<div class="layui-tree-emptyText">' + i.text.none + "</div>"), n.html(e.elem), 0 == e.elem.find(".layui-tree-set").length) return e.elem.append(e.elemNone);
        ...
        layui.each(e, function (e, i) {
            var a = i.children && 0 < i.children.length,
                n = h('<div class="layui-tree-pack" ' + (i.spread ? 'style="display: block;"' : "") + "></div>"),
                t = h(['<div data-id="' + i.id + '" class="layui-tree-set' + (i.spread ? " layui-tree-spread" : "") + (i.checked ? " layui-tree-checkedFirst" : "") + '">', '<div class="layui-tree-entry">', '<div class="layui-tree-main">', c.showLine ? a ? '<span class="layui-tree-iconClick layui-tree-icon"><i class="layui-icon ' + (i.spread ? "layui-icon-subtraction" : "layui-icon-addition") + '"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-icon"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-tree-iconArrow ' + (a ? "" : y) + '"></i></span>', c.showCheckbox ? '<input type="checkbox" name="' + (i.field || "layuiTreeCheck_" + i.id) + '" same="layuiTreeCheck" lay-skin="primary" ' + (i.disabled ? "disabled" : "") + ' value="' + i.id + '">' : "", c.isJump && i.href ? '<a href="' + i.href + '" target="_blank" class="' + b + '">' + (i.title || i.label || c.text.defaultNodeName) + "</a>" : '<span class="' + b + (i.disabled ? " " + o : "") + '">' + (i.title || i.label || c.text.defaultNodeName) + "</span>", "</div>", function () {
                    if (!c.edit) return "";
                    var a = {
            ...
            a && (t.append(n), r.tree(n, i.children)), l.append(t), t.prev("." + f)[0] && t.prev().children(".layui-tree-pack").addClass("layui-tree-showLine"), a || t.parent(".layui-tree-pack").addClass("layui-tree-lineExtend"), r.spread(t, i), c.showCheckbox && (i.checked && r.checkids.push(i.id), r.checkClick(t, i)), c.edit && r.operate(t, i)
        })
    }, l.prototype.spread = function (n, t) {
        var l = this, r = l.config, e = n.children("." + m), i = e.children("." + x),
            a = i.find('input[same="layuiTreeCheck"]'), c = e.find("." + k), e = e.find("." + b),
            d = r.onlyIconControl ? c : i, s = "";
        d.on("click", function (e) {
            var i = n.children("." + g),
                a = (d.children(".layui-icon")[0] ? d : d.find(".layui-tree-icon")).children(".layui-icon");
            i[0] ? n.hasClass(w) ? (n.removeClass(w), i.slideUp(200), a.removeClass(v).addClass(C), l.updateFieldValue(t, "spread", !1)) : (n.addClass(w), i.slideDown(200), a.addClass(v).removeClass(C), l.updateFieldValue(t, "spread", !0), r.accordion && ((i = n.siblings("." + f)).removeClass(w), i.children("." + g).slideUp(200), i.find(".layui-tree-icon").children(".layui-icon").removeClass(v).addClass(C))) : s = "normal"
        }), e.on("click", function () {
            h(this).hasClass(o) || (s = n.hasClass(w) ? r.onlyIconControl ? "open" : "close" : r.onlyIconControl ? "close" : "open", a[0] && l.updateFieldValue(t, "checked", a.prop("checked")), r.click && r.click({
                elem: n,
                state: s,
                data: t
            }))
        ...
        var t, n = this, l = (n.config, a.prop("checked"));
        a.prop("disabled") || ("object" != typeof i.children && !e.find("." + g)[0] || e.find("." + g).find('input[same="layuiTreeCheck"]').each(function (e) {
            //this.disabled || ((e = i.children[e]) && n.updateFieldValue(e, "checked", l), n.updateFieldValue(this, "checked", l))
        }), (t = function (e) {
            var i, a, n;
            e.parents("." + f)[0] && (a = (e = e.parent("." + g)).parent(), n = e.prev().find('input[same="layuiTreeCheck"]'), l ? n.prop("checked", l) : (e.find('input[same="layuiTreeCheck"]').each(function () {
                this.checked && (i = !0)
            }), i || n.prop("checked", !1)), t(a))
        })(e), n.renderForm("checkbox"))
    }, l.prototype.checkClick = function (a, n) {
        var t = this, l = t.config;
        a.children("." + m).children("." + x).on("click", 'input[same="layuiTreeCheck"]+', function (e) {
            layui.stope(e);
            var e = h(this).prev(), i = e.prop("checked");
        ...
        var s = this, o = s.config, e = c.children("." + m), u = e.children("." + x);
        e.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (e) {
            layui.stope(e);
            var i, e = h(this).data("type"), n = c.children("." + g), t = {data: d, type: e, elem: c};
            if ("add" == e) {
                n[0] || (o.showLine ? (u.find("." + k).addClass("layui-tree-icon"), u.find("." + k).children(".layui-icon").addClass(C).removeClass("layui-icon-file")) : u.find(".layui-tree-iconArrow").removeClass(y), c.append('<div class="layui-tree-pack"></div>'));
                var a, l = o.operate && o.operate(t), r = {};
                if (r.title = o.text.defaultNodeName, r.id = l, s.tree(c.children("." + g), [r]), o.showLine && (n[0] ? (n.hasClass(N) || n.addClass(N), c.find("." + g).each(function () {
                    h(this).children("." + f).last().addClass(F)
                }), (n.children("." + f).last().prev().hasClass(F) ? n.children("." + f).last().prev() : n.children("." + f).last()).removeClass(F), !c.parent("." + g)[0] && c.next()[0] && n.children("." + f).last().removeClass(F)) : (l = c.siblings("." + f), a = 1, r = c.parent("." + g), layui.each(l, function (e, i) {
                    h(i).children("." + g)[0] || (a = 0)
                }), 1 == a ? (l.children("." + g).addClass(T), l.children("." + g).children("." + f).removeClass(F), c.children("." + g).addClass(T), r.removeClass(N), r.children("." + f).last().children("." + g).children("." + f).last().addClass(F)) : c.children("." + g).children("." + f).addClass(F))), !o.showCheckbox) return;
                u.find('input[same="layuiTreeCheck"]')[0].checked && (c.children("." + g).children("." + f).last().find('input[same="layuiTreeCheck"]')[0].checked = !0), s.renderForm("checkbox")
            } else "update" == e ? (l = u.children("." + b).html(), u.children("." + b).html(""), u.append('<input type="text" class="layui-tree-editInput">'), u.children(".layui-tree-editInput").val(l).focus(), i = function (e) {
                var i = (i = e.val().trim()) || o.text.defaultNodeName;
                e.remove(), u.children("." + b).html(i), t.data.title = i, o.operate && o.operate(t)
            }, u.children(".layui-tree-editInput").blur(function () {
                i(h(this))
            }), u.children(".layui-tree-editInput").on("keydown", function (e) {
                13 === e.keyCode && (e.preventDefault(), i(h(this)))
                ...
                c.siblings("." + f).children("." + m)[0] ? (o.showCheckbox && (l = function (e) {
                    var i, a, n, t;
                    e.parents("." + f)[0] && (i = e.siblings("." + f).children("." + m), a = (e = e.parent("." + g).prev()).find('input[same="layuiTreeCheck"]')[0], n = 1, (t = 0) == a.checked && (i.each(function (e, i) {
                        i = h(i).find('input[same="layuiTreeCheck"]')[0];
                        0 != i.checked || i.disabled || (n = 0), i.disabled || (t = 1)
                    }), 1 == n && 1 == t && (a.checked = !0, s.renderForm("checkbox"), l(e.parent("." + f)))))
                })(c), o.showLine && (e = c.siblings("." + f), a = 1, i = c.parent("." + g), layui.each(e, function (e, i) {
                    h(i).children("." + g)[0] || (a = 0)
                }), 1 == a ? (n[0] || (i.removeClass(N), e.children("." + g).addClass(T), e.children("." + g).children("." + f).removeClass(F)), (c.next()[0] ? i.children("." + f).last() : c.prev()).children("." + g).children("." + f).last().addClass(F), c.next()[0] || c.parents("." + f)[1] || c.parents("." + f).eq(0).next()[0] || c.prev("." + f).addClass(F)) : !c.next()[0] && c.hasClass(F) && c.prev().addClass(F))) : (e = c.parent("." + g).prev(), o.showLine ? (e.find("." + k).removeClass("layui-tree-icon"), e.find("." + k).children(".layui-icon").removeClass(v).addClass("layui-icon-file"), (i = e.parents("." + g).eq(0)).addClass(N), i.children("." + f).each(function () {
                    h(this).children("." + g).children("." + f).last().addClass(F)
        ...
        i.setChecked(i.checkids), i.elem.find(".layui-tree-search").on("keyup", function () {
            var e = h(this), a = e.val(), e = e.nextAll(), n = [];
            e.find("." + b).each(function () {
                var i, e = h(this).parents("." + m);
                -1 != h(this).html().indexOf(a) && (n.push(h(this).parent()), (i = function (e) {
                    e.addClass("layui-tree-searchShow"), e.parent("." + g)[0] && i(e.parent("." + g).parent("." + f))
                })(e.parent("." + f)))
            }), e.find("." + m).each(function () {
                var e = h(this).parent("." + f);
            ...
            h(this).nextAll().find("." + m).each(function () {
                h(this).parent("." + f).removeClass("layui-tree-searchShow " + y)
            }), h(".layui-tree-emptyText")[0] && h(".layui-tree-emptyText").remove()
        })
    }, l.prototype.getChecked = function () {
        var t = this, e = t.config, i = [], a = [], l = (t.elem.find(".layui-form-checked").each(function () {
            i.push(h(this).prev()[0].value)
        }), function (e, n) {
            layui.each(e, function (e, a) {
                layui.each(i, function (e, i) {
                    if (a.id == i) return t.updateFieldValue(a, "checked", !0), delete (i = h.extend({}, a)).children, n.push(i), a.children && (i.children = [], l(a.children, i.children)), !0
                })
            })
        });
        return l(h.extend({}, e.data), a), a
    }, l.prototype.setChecked = function (l) {
        this.config;
        this.elem.find("." + f).each(function (e, i) {
            var a = h(this).data("id"), n = h(i).children("." + m).find('input[same="layuiTreeCheck"]'), t = n.next();
            if ("number" == typeof l) {
    ...
    }, t.that = {}, t.config = {}, n.reload = function (e, i) {
        e = t.that[e];
        return e.reload(i), t.call(e)
    }, n.getChecked = function (e) {
        return t.that[e].getChecked()
    }, n.setChecked = function (e, i) {
...
layui.define(["lay", "util", "element", "form"], function (e) {
    "use strict";
    var C = layui.$, w = layui.util, b = layui.element, g = layui.form, T = layui.layer, x = {
        ...
        encode: !0,
        copy: !0,
        text: {code: w.escape("</>"), preview: "Preview"}
    }, I = function (e) {
    ...
    e("code", function (e) {
        ...
        e.elem = C(e.elem), e.elem[0] && layui.each(e.elem.get().reverse(), function (e, a) {
            var t, l, i, o, n, s, c, d, r, u, y, E, p = C(a),
                ...
                }), t)), v = p.data("code") || (i = [], p.children("textarea").each(function () {
                    i.push(I(this.value))
                }), 0 === i.length && i.push(I(p.html())), i), a = (p.data("code", v), l = v.join("")),
                h = ("function" == typeof f.codeParse && (a = l = f.codeParse(a)), {
                    copy: {
                        className: "file-b",
                        title: ["\u590d\u5236\u4ee3\u7801"],
                        event: function (e, a) {
                            if ("function" == typeof f.onCopy) f.onCopy(l); else try {
                ...
                m = (f.preview && (o = "LAY-CODE-DF-" + e, E = f.layout || ["code", "preview"], n = "iframe" === f.preview, u = C('<div class="' + x.ELEM_PREVIEW + '">'), y = C('<div class="layui-tab layui-tab-brief">'), s = C('<div class="layui-tab-title">'), c = C('<div class="' + [x.ELEM_ITEM, x.ELEM_ITEM + "-preview", "layui-border"].join(" ") + '">'), d = C('<div class="layui-code-tools"></div>'), M = p.parent("." + x.ELEM_PREVIEW), m = p.prev("." + x.ELEM_TAB), L = p.next("." + x.ELEM_ITEM + "-preview"), f.id && u.attr("id", f.id), u.addClass(f.className), y.attr("lay-filter", o), f.encode = !0, layui.each(E, function (e, a) {
                    ...
                    full: {
                        ...
                        title: ["\u6700\u5927\u5316\u663e\u793a", "\u8fd8\u539f\u663e\u793a"],
                        event: function (e, a) {
                            var i = e.closest("." + x.ELEM_PREVIEW), t = "layui-icon-" + this.className,
                                l = "layui-icon-screen-restore", o = this.title, n = C("html,body"),
                                s = "layui-scrollbar-hide";
                    ...
                    var a = e.children("iframe")[0], i = (n && a ? a.srcdoc = l : e.html(v.join("")), {
                        container: e, render: function () {
                    ...
                    var a = C(this), i = C(e.elem).closest("." + x.ELEM_PREVIEW).find("." + x.ELEM_ITEM),
                        e = i.eq(e.index);
                    i.removeClass(x.ELEM_SHOW), e.addClass(x.ELEM_SHOW), "preview" === a.attr("lay-id") && r(e)
                })), f.ln ? "ol" : "ul"), L = C("<" + m + ' class="layui-code-' + m + '">'),
